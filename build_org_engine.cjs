...
fs.mkdirSync('src/services/organization', { recursive: true });
...
fs.writeFileSync('src/services/organization/OrganizationEngine.ts', orgEngine);
console.log("Created OrganizationEngine");
