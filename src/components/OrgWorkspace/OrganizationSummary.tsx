...
export function OrganizationSummary() {
  ...
  if (loading || !data) return <div className="text-slate-500 p-8">Loading Summary...</div>;

  const items = [
    { label: 'Total Company', value: data.company, icon: <Building2 className="w-5 h-5 text-blue-600" /> },
