...
export function DependencyGraph() {
  const steps = [
    { label: 'Company', icon: <Building2 className="w-5 h-5" />, color: 'text-blue-600 bg-blue-50 border-blue-500/20' },
    { label: 'Branch', icon: <MapPin className="w-5 h-5" />, color: 'text-green-400 bg-green-500/10 border-green-500/20' },
    { label: 'Division', icon: <Layers className="w-5 h-5" />, color: 'text-purple-400 bg-purple-50 border-purple-500/20' },
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-lg p-6">
      <h3 className="text-slate-900 font-medium mb-6">Structural Dependency</h3>
